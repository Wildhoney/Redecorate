...
function apply(state) {
    ...
    return (property, reducer) => {
        ...
        if (parts.length === 1) {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_object_assign___default()({}, state, {
...
function add(...x) {
    ...
    return cursor => {
        ...
        switch (type(cursor)) {
            ...
            case 'object':
                const combined = __WEBPACK_IMPORTED_MODULE_0_object_assign___default()({}, ...x);
                ...
                switch (type(x)) {
                    ...
                    case 'array':
                        return cursor.filter(current => {
                            return !x.filter(matcher => Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["matches"])(matcher)(current)).length;
                        });
