...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectAssign3 = __webpack_require__(1);
	...
	function apply(state) {
	    ...
	    return function (property, reducer) {
	        ...
	        if (parts.length === 1) {
	            ...
	            var immutable = Object.isFrozen(state[property]) ? state[property] : new _seamlessImmutable2.default(state[property]);

	            return (0, _objectAssign4.default)({}, state, _defineProperty({}, property, reducer(immutable)));
	        }

	        return (0, _objectAssign4.default)({}, state, _defineProperty({}, first, apply(state[first])(parts.slice(1).join('.'), reducer)));
	    };
	}
	...
	function add() {
	    ...
	    return function (cursor) {
	        ...
	        switch (type(cursor)) {
	            ...
	            case 'array':
	                return [].concat(_toConsumableArray(cursor), x);

	            case 'object':
	                var combined = _objectAssign4.default.apply(undefined, [{}].concat(x));
	                return _extends({}, cursor, _extends({}, combined));
	                    ...
	                    case 'array':
	                        return cursor.filter(function (current) {
	                            return !x.filter(function (matcher) {
	                                return (0, _lodash.matches)(matcher)(current);
	                            }).length;
	                        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(6), __webpack_require__(3)(module), (function() { return this; }())))
